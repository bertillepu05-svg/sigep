"""
Django settings for projet_sigep project.
...
ROOT_URLCONF = 'projet_sigep.urls'
...
WSGI_APPLICATION = 'projet_sigep.wsgi.application'
...
os.makedirs(os.path.join(MEDIA_ROOT, 'upload_profils'), exist_ok=True)
